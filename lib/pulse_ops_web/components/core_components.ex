defmodule PulseOpsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PulseOpsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PulseOpsWeb.Gettext, "errors", msg, opts)
    end
  end
