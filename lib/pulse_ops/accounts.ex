defmodule PulseOps.Accounts do
  @moduledoc """
  ...
  alias PulseOps.Accounts.UserNotifier
  ...
  def register_user(attrs) do
    ...
    |> PulseOps.Organizations.create_personal_organization_multi(:user)
    |> Repo.transaction()
    |> case do
  ...
  See `PulseOps.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `PulseOps.Accounts.User.password_changeset/3` for a list of supported options.
